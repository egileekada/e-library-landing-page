...
function Tiles(props: IPartner) {
    ...
    return (
        <Box as='button' w={"full"} textAlign={"left"} onClick={() => clickHandler()} pos={"relative"} p={"4"} >
            ...
            <Flex w={"full"} gap={"4"} >
                <Button onClick={()=> navigate("")} h={"45px"} gap={"2"} rounded={"5px"} width={"full"} mt={"4"} bgColor={"#1F7CFF"} _hover={{ backgroundColor: "#1F7CFF" }} display={"flex"} alignItems={"center"} justifyContent={"center"} color={"white"} >
                    View
                </Button>
