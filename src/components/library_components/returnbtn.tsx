...
function Returnbtn(props: ILibrary) {
    ...
    return (
        <>
            ...
            {!table && (
                <Button onClick={() => clickHandler()} h={"45px"} gap={"2"} rounded={"5px"} width={"full"} mt={"4"} fontWeight={"500"} fontSize={"14px"} bgColor={"#FFF"} border={"1px solid #1F7CFF"} _hover={{ backgroundColor: "#FFF" }} display={"flex"} alignItems={"center"} justifyContent={"center"} color={"#1F7CFF"} >
                    Return
                </Button>
            )}
