...
function GadgetsPage(props: Props) {
    ...
    return (
        <Flex width={"full"} height={"full"} flexDir={"column"} pb={"4"} >
            <Filter data={data} name='Gadget' />
            <GadgetTable setDataInfo={setData} tableRef={tableRef} setLimit={setLimit} setPage={setPage} setTotal={setTotalItem} limit={limit} page={page}  />
            <Box mt={"auto"} pt={"12"} > 
